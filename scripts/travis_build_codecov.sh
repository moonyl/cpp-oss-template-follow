...
make unitTest
lcov --gcov-tool /usr/bin/gcov-7 -c -i -d tests/unitTest -o base.info
bin/unitTest
lcov --gcov-tool /usr/bin/gcov-7 -c -d tests/unitTest -o test.info
...
lcov --gcov-tool /usr/bin/gcov-7 -r coverage.info '*/third-party/*' -o coverage.info
